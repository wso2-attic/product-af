...
class WSO2ESBStartupHandler(ICartridgeAgentPlugin):
    ...
    def run_plugin(self, values):
        ...
        output, errors = p.communicate()
        WSO2ESBStartupHandler.log.info("S2git host entry added successfully")
        ...
        p = subprocess.Popen(entry_command, env=env_var, shell=True)
        output, errors = p.communicate()
        WSO2ESBStartupHandler.log.info("BAM host entry added successfully")
        ...
        p = subprocess.Popen(entry_command, env=env_var, shell=True)
        output, errors = p.communicate()
        WSO2ESBStartupHandler.log.info("Thrift host entry added successfully")
        ...
        p = subprocess.Popen(entry_command, env=env_var, shell=True)
        output, errors = p.communicate()
        WSO2ESBStartupHandler.log.info("Messaging host entry added successfully")
        ...
        p = subprocess.Popen(entry_command, env=env_var, shell=True)
        output, errors = p.communicate()
        WSO2ESBStartupHandler.log.info("Social host entry added successfully")
	...
	lbDomain = values.get("LB_DOMAIN")
        ...
        p = subprocess.Popen(entry_command, env=env_var, shell=True)
        output, errors = p.communicate()
        WSO2ESBStartupHandler.log.info("LB host entry added successfully")
        ...
        p = subprocess.Popen(entry_command, env=env_var, shell=True)
        output, errors = p.communicate()
        WSO2ESBStartupHandler.log.info("Mysql host entry added successfully")
        ...
        p = subprocess.Popen(entry_command, env=env_var, shell=True)
        output, errors = p.communicate()
        WSO2ESBStartupHandler.log.info("App Factory host entry added successfully")
