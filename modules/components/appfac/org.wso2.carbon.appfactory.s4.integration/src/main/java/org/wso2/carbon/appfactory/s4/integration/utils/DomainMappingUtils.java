...
public class DomainMappingUtils {
    ...
    private static final String DEFAULT_URL_FORMAT = DEFAULT_URL_PREFIX +"."+ DEFAULT_URL_MIDDLE +"."+ DEFAULT_URL_SUFFIX;
     ...
     */
    public static DomainMappingResponse sendPostRequest(String stage, String body,
     ...
     * @throws AppFactoryException
     */
    public static DomainMappingResponse sendDeleteRequest(String stage,
     ...
     * @throws AppFactoryException
     */
    public static DomainMappingResponse sendGetRequest(String stage,
                                                       String getSubscriptionDomainEndPoint)
            throws AppFactoryException {
    ...
    public static String generateAddSubscriptionDomainJSON(String domain, String appKey,
        ...
        try {
            ...
            String errorMsg = "Error while generating json string for application id:" + appKey + " domain: " + domain + " version: " + version;
            log.error(errorMsg, e);
            throw new AppFactoryException(errorMsg);
        } catch (MalformedURLException e) {
            String errorMsg = "Error while generating application context for application id:" + appKey + " domain: " +
                              domain + " " +
                              "version: " + version;
            log.error(errorMsg, e);
            throw new AppFactoryException(errorMsg);
    ...
    public static String getDefaultMappingContext() {
        return ServiceHolder.getAppFactoryConfiguration()
                .getFirstProperty("DefaultMappingContext");
    }
            ...
            case ADD_DOMAIN_MAPPING:
                for (DomainMapperEventHandler<?> aDomainEventHandler1 : domainEventHandler) {
                    ...
                    try {
                        ...
                        String msg =
                                "Error occurred invoking domain mapping created event for " +
                                domain;
                        log.error(msg, e);
                        throw new AppFactoryException(msg, e);
                    }
            ...
            case REMOVE_DOMAIN_MAPPING:
                for (DomainMapperEventHandler<?> aDomainEventHandler : domainEventHandler) {
                    ...
                    try {
                        ...
                        String msg =
                                "Error occurred invoking domain mapping removed event for " +
                                domain;
                        log.error(msg, e);
                        throw new AppFactoryException(msg, e);
                    }
    ...
    public static String getSubDomain(String defaultUrl) {
        String defaultHostName = DEFAULT_DOMAIN_SEPERATOR + ServiceHolder.getAppFactoryConfiguration().getFirstProperty("DomainName");
    ...
    public static String getDefaultDomain(String appKey) throws AppFactoryException {
        ...
        if (StringUtils.isNotBlank(defaultSubDomain)) {
            ...
            return defaultSubDomain + DEFAULT_DOMAIN_SEPERATOR + ServiceHolder.getAppFactoryConfiguration().getFirstProperty("DomainName");
        } else {
            return null;
        }
    ...
    public static String generateDefaultProdUrl(String prefix, String middle, String suffix) {
        return DEFAULT_URL_FORMAT.replace(DEFAULT_URL_PREFIX, prefix).replace(DEFAULT_URL_MIDDLE,
                                                                              middle).replace(DEFAULT_URL_SUFFIX, suffix);
    }
}
