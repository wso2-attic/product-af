...
public interface DomainMapperEventHandler<T> extends Comparable<T> {

	/**
	 * This event will get called when domain mapping is added
	 * 
	 * @param domains
	...
	/**
	 * This event will get called when domain mapping is removed
	 * 
	 * @param domains
	 * @throws AppFactoryException
	 */
