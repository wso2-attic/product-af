	...
	public void deleteResource(String applicationId, AppFactoryResource appFactoryResource) throws AppFactoryException {
		...
		String path =
		              RegistryConstants.PATH_SEPARATOR + allowedRegistryPath + RegistryConstants.PATH_SEPARATOR +
		                      applicationId + RegistryConstants.PATH_SEPARATOR + appFactoryResource.getResourceName();
		try {
			...
			String errorMsg =
			                  "Resource:" + appFactoryResource.getResourceName() + " for application:" + applicationId +
			                          " already exists.";
			log.error(errorMsg);
		...
		try {
			...
			String path =
			              RegistryConstants.PATH_SEPARATOR + allowedRegistryPath + RegistryConstants.PATH_SEPARATOR +
			                      ...
			                      appFactoryResource.getResourceName();
			...
			if (registry.resourceExists(path)) {
				if (isUpdate) {
					...
					String errorMsg =
					                  "Resource:" + appFactoryResource.getResourceName() + " for application:" +
			...
			String errorMsg =
			                  "Failed to add resource:" + appFactoryResource.getResourceName() + " for application:" +
			                          applicationId;
