...
public class AppfactoryRepositoryClient {
    ...
    public boolean checkIn(String url, File checkInDirectory, String msg, boolean isRemoveCheckInDirectory)
            throws AppFactoryException {
        return scmClient.checkIn(getSCMURL(url), checkInDirectory, msg , isRemoveCheckInDirectory);
    }
    ...
    public boolean update(String url,File trunk)throws AppFactoryException{
        return scmClient.update(getSCMURL(url),trunk);
    }
    public boolean status(String url,File trunk) throws AppFactoryException{
        return scmClient.status(getSCMURL(url), trunk);
    }
}
