...
public interface ContinuousIntegrationSystemDriver {
     ...
     *             if an error occurs
     */
    public void startBuild(String applicationId, String version, boolean doDeploy, String stageName, String tagName, String tenantDomain, String userName) throws AppFactoryException;
