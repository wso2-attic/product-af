...
public interface APIIntegration {
     ...
     * @param samlToken saml token for login to APIM
     ...
     */
    public boolean addAPIsToApplication(String applicationId, String apiName, String apiVersion, String apiProvider, String samlToken) throws AppFactoryException;
     ...
     */
    public boolean removeAPIFromApplication(String applicationId, String apiName, String apiVersion, String apiProvider, String samlToken) throws AppFactoryException;
     ...
     */
    public API getAPIInformation(String name, String version, String provider, String samlToken) throws AppFactoryException;
}
