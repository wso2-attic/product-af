...
public abstract class ApplicationEventsHandler implements Comparable<ApplicationEventsHandler> {
	 ...
	 */
	public abstract void onCreation(Application application, String userName, String tenantDomain)
	                                                                                              throws AppFactoryException;
	 ...
	 *            User name
	 * @param version 
	 * 			  Version that base to folk
	 * @param tenantDomain
	 *            Tenant domain of application
	 * @throws AppFactoryException
	 */
	public abstract void onForking(Application application,String version, String userName, String tenantDomain) throws AppFactoryException;
