...
public class PHPApplicationTypeProcessor extends AbstractApplicationTypeProcessor {
    ...
    public void doVersion(String applicationId, String targetVersion, String currentVersion, String workingDirectory) throws AppFactoryException {
        AppVersionStrategyExecutor.doVersionForPHP(targetVersion, new File(workingDirectory));
    }

    @Override
    public void generateApplicationSkeleton(String applicationID, String workingDirectory) throws AppFactoryException {
        ProjectUtils.generatePHPArchetype(applicationID, workingDirectory, getProperty(MAVEN_ARCHETYPE_REQUEST));
    }
}
