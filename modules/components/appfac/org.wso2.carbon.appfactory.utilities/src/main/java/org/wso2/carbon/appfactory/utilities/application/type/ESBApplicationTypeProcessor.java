 ...
 */
public class ESBApplicationTypeProcessor extends AbstractApplicationTypeProcessor {
    @Override
    public void doVersion(String applicationId, String targetVersion, String currentVersion, String workingDirectory) throws AppFactoryException {
        AppVersionStrategyExecutor.doVersionForESB(currentVersion, targetVersion, new File(workingDirectory));
    }

    @Override
    public void generateApplicationSkeleton(String applicationID, String workingDirectory) throws AppFactoryException {
        ProjectUtils.generateESBArchetype(applicationID, workingDirectory, getProperty(MAVEN_ARCHETYPE_REQUEST));
    }
}
