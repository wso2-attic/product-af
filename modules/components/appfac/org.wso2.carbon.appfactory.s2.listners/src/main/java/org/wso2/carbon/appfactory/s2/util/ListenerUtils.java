package org.wso2.carbon.appfactory.s2.util;
...
public class ListenerUtils {
	...
	public static List<CloudRegistryResource> getCloudResourcePermissions()
		...
		AppFactoryConfiguration configurations = AppFactoryTenantMgtUtil.getConfiguration();
	...
	public static Registry getTenantRegistryObj(int tenantId) throws AppFactoryException {
		try {
			AppFactoryTenantMgtUtil.getTenantRegistryLoader().loadTenantRegistry(tenantId);
			return AppFactoryTenantMgtUtil.getRegistryService()
