...
public class ApplicationManagementServiceComponent {
    ...
    protected void activate(ComponentContext context) {
        ...
        bundleContext.registerService(ApplicationUserManagementService.class.getName(),new ApplicationUserManagementService(),null);
        bundleContext.registerService(ApplicationEventsHandler.class.getName(),
                new StatPublishEventsListener(), null);
        bundleContext.registerService(ApplicationEventsHandler.class.getName(),
                new EnvironmentAuthorizationListener() , null);
        ...
        bundleContext.registerService(ApplicationEventsHandler.class
				.getName(), new NonBuildableApplicationEventListner(), propsNonBuild);
