...
/**
 * Base class for Single tenant applications
 */
public abstract class AbstractSingleTenantApplicationTypeProcessor extends AbstractApplicationTypeProcessor {
    ...
    private static final String RETRY_COUNT = "AbstractSingleTenantApplicationTypeProcessor.RetryCount";
    private static final String RETRY_DELAY = "AbstractSingleTenantApplicationTypeProcessor.RetryDelay";
    ...
    @Override
    public String getDeployedURL(String tenantDomain, String applicationId, String applicationVersion,
        ...
        try {
            ...
            String cartridgeActiveIp = getCartridgeActiveIP(applicationId, applicationVersion, tenantDomain, stage,
                                                            true);
     ...
     * @param tenantDomain
     * @param stage
     * @param subscribeOnDeployment
     * @return
     * @throws AppFactoryException
     */
    public String getCartridgeActiveIP(String applicationId, String applicationVersion, String tenantDomain,
                                       String stage, boolean subscribeOnDeployment) throws AppFactoryException {

        AppFactoryConfiguration configuration = AppFactoryUtil.getAppfactoryConfiguration();
        String serverURL = configuration.getFirstProperty(ENVIRONMENT + XPATH_SEPERATOR + stage
                                                                  + XPATH_SEPERATOR + TENANT_MANAGEMENT_URL);
        String userName = CarbonContext.getThreadLocalCarbonContext().getUsername() + SYMBOL_AT + CarbonContext
            ...
            for (int i = 0; i < retryCount; i++) {
                ...
                if (cartridgeCluster != null) {
                    ...
                    if (currentStatus.getLastDeployedStatus() == null) {
                        ...
                        jdbcApplicationDAO.updateLastDeployStatus(applicationId, applicationVersion, stage, false, null,
                                                                  currentStatus);
                    }
