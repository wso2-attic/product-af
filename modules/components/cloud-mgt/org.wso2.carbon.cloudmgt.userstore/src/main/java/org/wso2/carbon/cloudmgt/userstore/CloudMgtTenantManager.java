 ...
 */
public class CloudMgtTenantManager extends CommonHybridLDAPTenantManager {
    private static Log logger = LogFactory.getLog(CloudMgtTenantManager.class);
    ...
    public CloudMgtTenantManager(OMElement omElement, Map<String, Object> properties)
            throws Exception {
    ...
    public CloudMgtTenantManager(DataSource dataSource, String superTenantDomain) {
