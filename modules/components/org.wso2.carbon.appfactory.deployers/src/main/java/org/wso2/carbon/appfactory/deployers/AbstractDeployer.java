...
public abstract class AbstractDeployer implements Deployer {
	...
	public void deployPromotedArtifact(Map<String, String[]> parameters)
		...
		File[] fileToDeploy = getArtifact(pathToPromotedArtifact, extension, stageName, applicationId);
    ...
    public void deployLatestSuccessArtifact(Map<String, String[]> parameters)
		...
		try {
			...
			File[] artifactToDeploy = getLastBuildArtifact(path, extension, stageName, applicationId);
     ...
     */
    protected File[] getLastBuildArtifact(String path, String extension, String stage, String applicationId) throws AppFactoryException {
	    if (StringUtils.isBlank(extension)) {
		    path = path + File.separator + FREE_STYLE_APP_TYPE_FILE_PATH;
	    }
	    return getArtifact(path, extension, stage, applicationId);
    }
	...
	public void labelLastSuccessAsPromoted(String applicationId, String version, String artifactType, String stage,
		...
		File[] lastSucessFiles = getLastBuildArtifact(lastSucessBuildFilePath, extension, stage, applicationId);
