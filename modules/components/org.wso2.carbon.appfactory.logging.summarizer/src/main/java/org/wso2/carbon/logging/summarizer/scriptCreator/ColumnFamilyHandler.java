...
//                                credentials);
    ...
    public void deleteColumnFamily(String columnFamily, String rectifiedCFName, DataPublisher dataPublisher) throws SummarizerException, AgentException, MalformedURLException, AuthenticationException, TransportException, StreamDefinitionException, NoStreamDefinitionExistException {
    	 //deleting the stream
        ...
        log.info("CF "+ columnFamily + " Deleted sucessfully ");
        DateFormat dateFormat = new SimpleDateFormat("yyyy_MM_dd");
        Date date = new Date();
