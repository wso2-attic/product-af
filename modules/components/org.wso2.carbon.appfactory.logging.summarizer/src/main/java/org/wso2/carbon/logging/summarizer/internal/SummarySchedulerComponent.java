...
public class SummarySchedulerComponent {
    ...
    protected void activate(ComponentContext ctx) {
    	log.info("Starting SummarySchedulerComponent");
        ...
        try {
			SummaryDataHolder.getTask().registerTaskType(SummarizingConstants.TASK_NAME);
		} catch (TaskException e) {
			log.error("Error in registering summarizer task type: " + e.getMessage(), e);
		}
    }
