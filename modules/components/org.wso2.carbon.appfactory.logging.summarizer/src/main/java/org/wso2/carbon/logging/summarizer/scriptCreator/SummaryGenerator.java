...
public class SummaryGenerator {
	...
	public void doSummarization() throws SummarizerException, AgentException,
		...
		try {
            ...
            for (Map.Entry<String, String> entry : queryList.entrySet()) {
                ...
                if (isDeleteColFamily) {
                    ...
                    try {
                    	log.info("Log deletion started.");
                        columnFamilyHandler.deleteColumnFamily(colFamilyName,rectifiedCFName,dataPublisher);
