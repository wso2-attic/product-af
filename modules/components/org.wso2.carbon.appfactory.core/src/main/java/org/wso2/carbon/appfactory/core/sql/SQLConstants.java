...
public class SQLConstants {
    ...
    public static final String GET_AUTO_BUILD_STATUS_OF_VERSION = "SELECT AUTO_BUILD FROM AF_VERSION " +
            " WHERE APPLICATION_ID=? AND VERSION_NAME=?";
    ...
    public static final String GET_AUTO_DEPLOY_STATUS_OF_VERSION = "SELECT AUTO_DEPLOY FROM AF_VERSION " +
            " WHERE APPLICATION_ID=? AND VERSION_NAME=?";
    public static final String UPDATE_SUBDOMIN_OF_VERSION = "UPDATE AF_VERSION SET " +
            "SUBDOMIN=? WHERE APPLICATION_ID=? AND VERSION_NAME=?";

    public static final String GET_STAGE_OF_APPLICATION_VERSION = "SELECT AF_VERSION.STAGE AS STAGE FROM "
            + "( SELECT * FROM AF_APPLICATION WHERE APPLICATION_NAME=? ) AS X INNER JOIN AF_VERSION " +
