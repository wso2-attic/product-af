...
public class ResourceManager {
     ...
     * @throws AppFactoryException
     */
    public static boolean deleteProperty(String applicationKey, String propName, String environment, String resourceType)
            throws AppFactoryException {
     ...
     *
     * @param applicationKey key of the application, which's properties need to be retrieved
