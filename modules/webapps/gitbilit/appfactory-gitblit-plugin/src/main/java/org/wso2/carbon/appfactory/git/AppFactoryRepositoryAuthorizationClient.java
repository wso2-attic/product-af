...
public class AppFactoryRepositoryAuthorizationClient {
    ...
    public AppFactoryRepositoryAuthorizationClient(GitBlitConfiguration configuration) {
        ...
        try {
            ...
            serviceStub = new RepositoryAuthenticationServiceStub(context, configuration.getProperty
                    (GitBlitConstants
                            .APPFACTORY_URL, GitBlitConstants.APPFACTORY_DEFAULT_URL) + "/services/RepositoryAuthenticationService");
    ...
    public boolean authorize(String userName, String repositoryName, String repositoryAction, String fullRepoName) {
        ...
        try { 
        	...
        	serviceStub._getServiceClient().removeHeaders();
        	serviceStub._getServiceClient().addStringHeader(new QName("http://mutualssl.carbon.wso2.org","UserName","tns"), userName);
            ...
            log.error("Error while calling RepositoryAuthenticationService: Error is " + e.getLocalizedMessage(), e);
