...
public class AppFactoryGitBlitAuthenticationProvider extends AuthenticationProvider.UsernamePasswordAuthenticationProvider  implements IUserService{
         ...
         */
        private static Map<String, GitBlitUserModelHolder> userModelMap = new HashMap<String, GitBlitUserModelHolder>();
    ...
    public UserAdminServiceClient getUserAdminServiceClient() {
        ...
        public void setup() {
            ...
            try {
                System.setProperty("javax.net.ssl.trustStore", configuration.getProperty
                        (GitBlitConstants.APPFACTORY_TRUST_STORE_LOCATION,
                                new File(".").getCanonicalPath() + GitBlitConstants.APPFACTORY_TRUST_STORE_DEFAULT_LOCATION));
                System.setProperty("javax.net.ssl.keyStore", configuration.getProperty
                        (GitBlitConstants.APPFACTORY_KEY_STORE_LOCATION,
                                new File(".").getCanonicalPath() + GitBlitConstants.APPFACTORY_KEY_STORE_DEFAULT_LOCATION));
            } catch (IOException e) {
            ...
            System.setProperty("javax.net.ssl.trustStorePassword", configuration.getProperty
                    (GitBlitConstants.APPFACTORY_TRUST_STORE_PASSWORD, GitBlitConstants.APPFACTORY_TRUST_STORE_DEFAULT_PASSWORD));
            System.setProperty("javax.net.ssl.keyStorePassword", configuration.getProperty
                    (GitBlitConstants.APPFACTORY_KEY_STORE_PASSWORD, GitBlitConstants.APPFACTORY_KEY_STORE_DEFAULT_PASSWORD));
        ...
        public UserModel authenticate(String username, char[] password) {
            ...
            if (authenticateAdmin(username, password) || (cookie = client.authenticate(username,
                ...
                //if(this.userManager instanceof AppFactoryGitBlitAuthenticationProvider){
//                    AppFactoryGitBlitUserService userService = (AppFactoryGitBlitUserService)this.userManager;
