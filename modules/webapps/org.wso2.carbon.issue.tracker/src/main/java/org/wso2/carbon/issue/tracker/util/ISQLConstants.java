...
public interface ISQLConstants {
    ...
    String UPDATE_ISSUE = "UPDATE ISSUE SET SUMMARY = ?, DESCRIPTION = ?, ISSUE_TYPE = ?, PRIORITY = ?, STATUS = ?, " +
                          "ASSIGNEE = ?, VERSION_ID = ?, UPDATED_TIME = ?, SEVERITY = ? WHERE PKEY = ? AND ORGANIZATION_ID = ?";
