...
public class SpringApplicationCreationTestCase extends AFIntegrationTest {
	private static final Log log = LogFactory.getLog(SpringApplicationCreationTestCase.class);
	public static final String APP_TYPE_SPRING = "spring";
	...
	public void testSpringAppType() throws Exception {
		String appName = "foo_" + APP_TYPE_SPRING;
		log.info("Creating application of type :" + APP_TYPE_SPRING + " with name :" + appName);
		createApplication(AFIntegrationTestUtils.getDefaultTenantDomain(),
		                  ...
		                  appName, appName, appName, APP_TYPE_SPRING);
