...
public class AspectClass {
    ...
    public final void initRecoveryThreadClick(final ProceedingJoinPoint joinPoint) {
        advice(joinPoint);
    }
    ...
    public final void initRecoveryThreadClickAt(final ProceedingJoinPoint joinPoint) {
        advice(joinPoint);
    } 
    ...
    public final void initRecoveryThreadDoubleClick(final ProceedingJoinPoint joinPoint) {
        advice(joinPoint);
    } 
    ...
    public final void initRecoveryThreadDoubleClickAt(final ProceedingJoinPoint joinPoint) {
        advice(joinPoint);
    } 
     ...
     * Check tc failed.
     *
     * @param isTcfailed the is tcfailed
     */
     ...
     *
     * @param callers the caller
     * @param recoveryMethodName the recovery method names
     */
