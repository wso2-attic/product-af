...
SELECT RP.REG_PATH_VALUE, R.REG_TENANT_ID,C.REG_CONTENT_DATA FROM afregistry.REG_CONTENT C, afregistry.REG_RESOURCE R, afregistry.REG_PATH RP WHERE C.REG_CONTENT_ID = R.REG_CONTENT_ID AND C.REG_TENANT_ID = R.REG_TENANT_ID AND R.REG_MEDIA_TYPE = 'application/vnd.wso2-application+xml' AND R.REG_NAME IS NOT NULL AND RP.REG_PATH_ID=R.REG_PATH_ID;
