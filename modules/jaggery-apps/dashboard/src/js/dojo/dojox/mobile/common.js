...
if((_a("android")||_a("iphone")>=6)&&_5.global.onorientationchange!==undefined){
var _18=f;
f=function(evt){
...
var _1b=_a("android")?100:20;
_3.connect(null,"onresize",null,function(e){
var _1c=dm.getScreenSize();
if(_1c.w==_1a.w&&Math.abs(_1c.h-_1a.h)>=_1b){
_18(e);
}
_1a=_1c;
});
