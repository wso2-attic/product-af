//>>built
define("dojox/dgauges/components/black/CircularLinearGauge",["dojo/_base/lang","dojo/_base/declare","dojo/_base/Color","../../CircularGauge","../../LinearScaler","../../CircularScale","../../CircularValueIndicator","../../CircularRangeIndicator","../DefaultPropertiesMixin"],function(_1,_2,_3,_4,_5,_6,_7,_8,_9){
return _2("dojox.dgauges.components.black.CircularLinearGauge",[_4,_9],{borderColor:"#000000",fillColor:"#000000",indicatorColor:"#A4A4A4",constructor:function(){
...
_b.set("originX",186.9446);
_b.set("originY",184.74838);
_b.set("startAngle",130.16044);
_b.set("endAngle",50.25444);
