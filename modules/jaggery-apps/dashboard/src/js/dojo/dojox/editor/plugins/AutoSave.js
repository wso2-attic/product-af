...
var _19=/^\d{0,3}$/,_1a=String(val);
return Boolean(_1a.match?_1a.match(_19):"");
}});
_1.declare("dojox.editor.plugins.AutoSave",_18,{url:"",logResults:true,interval:0,_iconClassPrefix:"dijitEditorIconAutoSave",_MIN:60000,_setIntervalAttr:function(val){
this.interval=val;
},_getIntervalAttr:function(){
return this._interval;
},setEditor:function(_1b){
this.editor=_1b;
...
var _1c=new _2.Menu({style:"display: none"}),_1d=new _2.MenuItem({iconClass:this._iconClassPrefix+"Default "+this._iconClassPrefix,label:this._strings["saveLabel"]}),_1e=(this._menuItemAutoSave=new _2.MenuItem({iconClass:this._iconClassPrefix+"Setting "+this._iconClassPrefix,label:this._strings["saveSettingLabelOn"]}));
_1c.addChild(_1d);
_1c.addChild(_1e);
this.button=new _2.form.ComboButton({label:this._strings["saveLabel"],iconClass:this._iconClassPrefix+"Default "+this._iconClassPrefix,showLabel:false,dropDown:_1c});
this.connect(this.button,"onClick","_save");
this.connect(_1d,"onClick","_save");
this._menuItemAutoSaveClickHandler=_1.connect(_1e,"onClick",this,"_showAutSaveSettingDialog");
},_showAutSaveSettingDialog:function(){
var _1f=this._saveSettingDialog;
_1f.set("value",this.interval);
_1f.show();
},_onDialogOk:function(){
var _20=(this.interval=this._saveSettingDialog.get("value")*this._MIN);
if(_20>0){
this._setSaveInterval(_20);
...
var _26=o.args.name.toLowerCase();
if(_26=="autosave"){
