...
var _34=doc.selection?doc.selection.createRange():null;
if(_34){
if(_31){
_33.setEndPoint("EndToStart",_34);
}else{
_33.setEndPoint("StartToEnd",_34);
}
}
var _35=_30?4:0;
if(_31){
...
_32=_33.findText(txt,_33.text.length,_35);
if(_32){
_33.select();
}
}
...
return _32;
},_filterRegexp:function(_36,_37){
var rxp="";
var c=null;
