			...
			if(node == "pre"){
				...
				if(!o.parent().hasClass("snippet-wrap")){
					...
					if(defaults.clipboard!="" && defaults.clipboard!=false){
						...
						ZeroClipboard1.setMoviePath(defaults.clipboard);	
						var clip = new ZeroClipboard1.Client();
						clip.setText(txt);
...
var ZeroClipboard1 = {
	...
	Client: function(elem) {
		...
		// unique ID
		this.id = ZeroClipboard1.nextId++;
		this.movieId = 'ZeroClipboardMovie_' + this.id;
		
		// register client with singleton to receive flash events
		ZeroClipboard1.register(this.id, this);
...
ZeroClipboard1.Client.prototype = {
	...
	glue: function(elem, appendElem, stylesToAdd) {
		...
		this.domElement = ZeroClipboard1.$(elem);
		...
		if (typeof(appendElem) == 'string') {
			appendElem = ZeroClipboard1.$(appendElem);
		}
		...
		var box = ZeroClipboard1.getDOMObjectPosition(this.domElement, appendElem);
	...
	getHTML: function(width, height) {
		...
		if (navigator.userAgent.match(/MSIE/)) {
			...
			html += '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="'+protocol+'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="'+width+'" height="'+height+'" id="'+this.movieId+'" align="middle"><param name="allowScriptAccess" value="always" /><param name="allowFullScreen" value="false" /><param name="movie" value="'+ZeroClipboard1.moviePath+'" /><param name="loop" value="false" /><param name="menu" value="false" /><param name="quality" value="best" /><param name="bgcolor" value="#ffffff" /><param name="flashvars" value="'+flashvars+'"/><param name="wmode" value="transparent"/></object>';
		}
		else {
			// all other browsers get an EMBED tag
			html += '<embed id="'+this.movieId+'" src="'+ZeroClipboard1.moviePath+'" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="'+width+'" height="'+height+'" name="'+this.movieId+'" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" flashvars="'+flashvars+'" wmode="transparent" />';
		}
		return html;
	},
	...
	reposition: function(elem) {
		...
		if (this.domElement && this.div) {
			var box = ZeroClipboard1.getDOMObjectPosition(this.domElement);
			var style = this.div.style;
			style.left = '' + box.left + 'px';
			style.top = '' + box.top + 'px';
		}
