...
node 'base' {
  ...
  $mb_ip                = 'puppet' #since mb is in puppet master server
  $mb_port              = '61616'
  $mb_type		= 'activemq' #in wso2 mb case, value should be 'wso2mb'
  $cep_ip               = 'puppet' #since cep is in puppet master server
  $cep_port             = '7611'
  $cep_user_name        = 'admin'
  $cep_password         = 'password'
  ...
  $appfactory_host	= 'https://appfactory.private.wso2.com'
  $s2git_server		= 'https://gitblit.s2.wso2.com:8444/'
  $s2git_username	= 'admin'
  $s2git_password	= 'admin'
