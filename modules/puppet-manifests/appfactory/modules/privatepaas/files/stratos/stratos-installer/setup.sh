...
if [[ !(-d $stratos_extract_path) ]]; then
    ...
    cp -rf $current_dir/../patches/patch0008/ $stratos_path/apache-stratos-4.1.3/repository/components/patches/
    cp -rf $current_dir/../themes/theme1/* $stratos_path/apache-stratos-4.1.3/repository/deployment/server/jaggeryapps/console/themes/theme1/
    mv -f $stratos_path/apache-stratos-4.1.3 $stratos_extract_path
fi
