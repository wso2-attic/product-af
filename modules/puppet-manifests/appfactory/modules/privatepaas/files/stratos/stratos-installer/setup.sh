...
if [[ !(-d $stratos_extract_path) ]]; then
    ...
    cp -rf $current_dir/../patches/patch0008/ $stratos_path/apache-stratos-4.1.0-SNAPSHOT/repository/components/patches/
    cp -rf $current_dir/../themes/theme1/* $stratos_path/apache-stratos-4.1.0-SNAPSHOT/repository/deployment/server/jaggeryapps/console/themes/theme1/
